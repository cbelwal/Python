...
model_arma_1_1 = ARIMA(df.market_value, order=(1,0,1)) #ARMA 1,1
results_arma_1_1 = model_arma_1_1.fit()
print(results_arma_1_1.summary())

#------------------- Find MA 2
model_arma_2_1 = ARIMA(df.market_value, order=(2,0,1)) #ARMA 2,1
...
print("LLR Test:",LLR_test(model_arma_1_1, model_arma_2_1)) #0.0 is consodered high value


#------------ Print resisulta
print("Residuals:",results_arma_2_1.resid)

#---------------- AIC values
#-- For best model AIC should be least and LLR should be max
print("AIC model_arma_1_1:",results_arma_1_1.aic)
print("AIC model_arma_2_1:",results_arma_2_1.aic)