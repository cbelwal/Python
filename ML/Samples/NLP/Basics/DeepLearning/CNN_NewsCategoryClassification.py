...
Xtrain = tokenizer.texts_to_sequences(df_train['text']) #1557 documents of differerent sequences
...
i = Input(shape=(T,))
x = Embedding(V + 1, D)(i) #Embedding layers created the word vector, depth of embedding in D
