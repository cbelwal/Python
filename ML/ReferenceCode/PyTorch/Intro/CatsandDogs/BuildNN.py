...
test_transforms = transforms.Compose([transforms.Resize(255), #255 x 255 image
                                 transforms.CenterCrop(224), #224 x 224 pixel size
                                 transforms.ToTensor()])
...
testset = datasets.ImageFolder( dataDir + 'test', transform=train_transforms)
